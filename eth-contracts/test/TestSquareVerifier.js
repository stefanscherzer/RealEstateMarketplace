...
contract('SquareVerifier', accounts => {
    ...
    describe('Testing the SquareVerifier', function () {
        ...
        it('Test verification with correct proof', async function () {
            ...
            let output = await this.contract.verifyTx.call(proof.a, proof.b, proof.c, inputs);
            assert.equal(output, true, "Test verification failed!");
        })
        ...
        it('Test verification with incorrect proof', async function () {
            ...
            let output = await this.contract.verifyTx.call(proof.a, proof.b, proof.c, inputs);
            assert.equal(output, false, "Test verification did not fail even if it should!");
        })
    })
})
